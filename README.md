...
# Example of using Seed with comp_state

Example seed app using per-component state managed via comp_state. A todo style example.

The below is Standard Quickstart informaiton.
